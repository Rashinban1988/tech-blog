...
function origin_theme_enqueue_scripts()
{
  ...
  $timestamp = date('Ymdgis', filemtime(get_stylesheet_directory() . '/scss/styles.css'));
  wp_enqueue_style('add-common-style', get_stylesheet_directory_uri() . '/scss/styles.css', [], $timestamp);
}
