      ...
      <div class="article-page__inner news">
        <article class="article-page__contents">
          ...
          <?php else: ?>
            <div class="column-archive__category__wrapper">
              ...
              <div class="contents-wrapper">
                ...
                <a href="<?php echo home_url('/tech-blog'); ?>" class="current">すべて</a>
          ...
          <div class="column-archive__article-list">
            <?php
            $techBlogs = TechBlogService::get_tech_blogs();
        ...
        <aside class="article-page__sidebar">
          <?php
            if(!wp_is_mobile()) {
              get_template_part('components/search/searchForm', 'tech-blog');
            }
          ?>
